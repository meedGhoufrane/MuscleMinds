                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $athlete->link_instagram_profile }}</td>
                                <td><img src="{{ asset($athlete->image) }}" alt="Athlete Image" width="100"></td> <!-- Display image -->
                                <td>
                                    <a href="{{ route('athletes.edit', $athlete->id) }}" class="btn btn-primary btn-sm">Edit</a>
